...
const CollegeCard: React.FC<CollegeCardProps> = ({ college }) => {
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border flex flex-col h-full ${
        isSelected
    ...
    >
      ...
      <div className="h-48 relative overflow-hidden">
        <img
          src={college.image || '/images/default-college.jpg'}
          alt={college.name}
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="mt-6 flex gap-2">
          <button
            ...
            className={`flex-1 text-center text-sm font-semibold py-2.5 rounded-lg transition-colors border flex items-center justify-center gap-1.5 ${
              isSelected
